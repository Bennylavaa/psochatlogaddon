...
-- so the same file is only loaded once.
--
...
--         image.Draw("addons/Chatlog/icon.png")
--
--         -- Or at a specific size:
--         image.Draw("addons/Chatlog/icon.png", 64, 64)
--
--         -- As a clickable button:
--         if image.Button("addons/Chatlog/btn.png", 32, 32) then
--             -- clicked
--         end
--     end
